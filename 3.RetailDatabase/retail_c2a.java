...
public class retail_c2a {
		...
		//private Text str1 = new Text();
	      ...
	      {	    	  
	         try{
	            ...
	            long viable = cost-sales;
	            
	            String str2 = str[2]+","+viable;
	            context.write(new Text(str[4]),new Text(str2));
	         }
	         catch(Exception e)
	         {
	...
	public static class CaderPartitioner extends Partitioner < Text, Text >
	  ...
	  public static void main(String[] args) throws Exception {
		    ...
		    job1.setJarByClass(retail_c2a.class);
			...
			job3.setJarByClass(retail_c2a.class);
